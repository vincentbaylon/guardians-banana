...
fighter_damage_skill = Skill.create!(skill_name: "Attack Skill", flavor_text: "", skill_effect: 20)
...
assassin_damage_skill = Skill.create!(skill_name: "Attack Skill", flavor_text: "", skill_effect: 20)
...
cleric_damage_skill = Skill.create!(skill_name: "Attack Skill", flavor_text: "", skill_effect: 20)
...
wizard_damage_skill = Skill.create!(skill_name: "Attack Skill", flavor_text: "", skill_effect: 20)
